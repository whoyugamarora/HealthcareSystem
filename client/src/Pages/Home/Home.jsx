        ...
        <div className="w-full min-h-screen">
            ...
            <header className="py-20 text-center bg-indigo-600 text-white">
                <div className="container mx-auto">
                    <h1 className="text-5xl md:text-7xl font-extrabold mb-6">HealthCare</h1>
                    <p className="text-sm md:text-lg">Access HealthCare facilities easily in a few clicks!</p>
                </div>
                <div className="mt-10">
                    <a
                        href="/login"
            ...
            <main className="py-16">
                ...
                <section className="container mx-auto px-6 pb-10">
                    <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-20 text-indigo-800">Features</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ">
                        <div className="py-20 px-5 bg-gray-100 rounded-lg shadow-md text-center">
                    ...
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                            <div className="py-20 px-5">
                                <FontAwesomeIcon icon={faSearch} size="2xl" className="mb-4 text-red-500" />
                            ...
                            <div className="py-20 px-5">
                                <FontAwesomeIcon icon={faCalendarCheck} size="2xl" className="mb-4 text-blue-600" />
                            ...
                            <div className="py-20 px-5">
                                <FontAwesomeIcon icon={faCheckCircle} size="2xl" className="mb-4 text-green-600" />
                ...
                <section className="container mx-auto px-6 py-10">
                    <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-20 text-indigo-800">What Our Users Say</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
                        <div className="py-20 px-5 bg-gray-100 rounded-lg shadow-md">
